...
### `zlibProvider`
- **Description:** ZLib compression algorithm provider used by the server. Check out <a href="/configuration/compression-acceleration">Hardware Compression Acceleration</a> for more information.
- **Accepted values:**
